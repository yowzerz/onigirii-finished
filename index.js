...
const player = new Fighter({
  ...
  takeHit: {
    imageSrc: './img/Ronin/Sprites/Take Hit - white silhouette.png',
    framesMax: 4
},
death: {
    imageSrc: './img/Ronin/Sprites/Death.png',
    framesMax: 6
}
...
const enemy = new Fighter({
  ...
  sprites: {
    ...
    takeHit: {
        imageSrc: './img/Onigirii/Sprites/Take hit.png',
        framesMax: 3
    },
    death: {
        imageSrc: './img/Onigirii/Sprites/Death.png',
        framesMax: 7
    }
  },
  attackBox: {
